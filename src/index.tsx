...
const App = () => {
  return (
    <ExposeProvider 
      ...
      blurAmount={8}
      onActivate={() => console.log('Expose activated')}
      onDeactivate={() => console.log('Expose deactivated')}
    >
      <div className="app">
        <header className="header">
          <h1>Expose Demo</h1>
          <div className="instructions">
            Press <kbd>Ctrl</kbd> + <kbd>↑</kbd> to activate Exposé view and see all windows.<br />
            Press <kbd>Esc</kbd> to return windows to their original positions.
          </div>
        </header>
        
        <div className="window-grid">
          <ExposeWrapper title="Analytics Dashboard" className="dashboard-window">
          ...
          <ExposeWrapper title="User Management" className="users-window">
          ...
          <ExposeWrapper title="Content Editor" className="editor-window">
...
"
          ...
          <ExposeWrapper title="Calendar" className="calendar-window">
          ...
          <ExposeWrapper title="Settings" className="settings-window">
          ...
          <ExposeWrapper title="Media Library" className="media-window">
